...
static inline ALWAYS_INLINE void depthwise_3x3_pad_1_(
  ...
  int32_t* row_offsets = static_cast<int32_t *>(genericMalloc(((K + 31) / 32 * 32)*sizeof(int32_t), 64));
...
depthwise_3x3_per_channel_quantization_pad_1_(
  ...
  int32_t* row_offsets = static_cast<int32_t*>(genericMalloc(((K + 31) / 32 * 32)*sizeof(int32_t), 64)); // __attribute__((aligned(64)));
